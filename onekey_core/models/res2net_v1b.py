...
class Res2Net(nn.Module):
    ...
    def __init__(self, block, layers, in_channels: int = 3, baseWidth=26, scale=4, num_classes=1000, **kwargs):
        self.inplanes = 64
...
def res2net50_v1b_26w_4s(pretrained=False, **kwargs):
    ...
    model = Res2Net(Bottle2neck, [3, 4, 6, 3], baseWidth=26, scale=4, **kwargs)
    if pretrained:
        model_state = load_state_dict_from_url(model_urls['res2net50_v1b_26w_4s'], progress=True,
                                               map_location=torch.device('cpu'))
